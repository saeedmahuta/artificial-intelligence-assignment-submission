...
#loading images
boatImg=pygame.image.load('animation/pygame/images/boat.png')
bgImg=pygame.image.load('animation/pygame/images/bg3.png')
mImg=pygame.image.load('animation/pygame/images/priest.png')
cImg=pygame.image.load('animation/pygame/images/cann.png')
c1Img=pygame.image.load('animation/pygame/images/cann1.png')
m1Img=pygame.image.load('animation/pygame/images/priest1.png')
ngImg=pygame.image.load('animation/pygame/images/newgame.png')
ng1Img=pygame.image.load('animation/pygame/images/newgame1.png')
gameoverImg=pygame.image.load('animation/pygame/images/gameover.png')
wonImg=pygame.image.load('animation/pygame/images/winner.png')
goImg=pygame.image.load('animation/pygame/images/go.png')
go1Img=pygame.image.load('animation/pygame/images/go1.png')
...
def main():
    ...
    mc=[]
    mc.insert(0,person(x-45,y-180,0,0,'M','left',mImg,m1Img,gameDisplay))
    mc.insert(1,person(x-0,y-180,0,0,'M','left',mImg,m1Img,gameDisplay))
    mc.insert(2,person(x--45,y-180,0,0,'M','left',mImg,m1Img,gameDisplay))
    ...
    while not crashed:
        ...
        if state==[0,0,0] and action==[0,0]:
            gameDisplay.blit(wonImg, (350, 150))
            won=True
